...
2. 在/usr/local/nginx下创建nginx.conf文件，格式如下
   ...
   server {
   	...
   	location ^~ /api/ {		
               proxy_pass http://120.78.154.83:8080/;
   ...
   server {
           listen       80;
           server_name  admin.diveintodream.cn;
...
2. 修改配置文件
   ...
   server {
           ...
           ssl on;
           ssl_certificate /etc/nginx/cert/diveintodream.cn_bundle.pem; 
   	    ssl_certificate_key /etc/nginx/cert/diveintodream.cn.key; 
   ...
   server {
           ...
           ssl on;
           ssl_certificate /etc/nginx/cert/admin.diveintodream.cn_bundle.pem; 
   	    ssl_certificate_key /etc/nginx/cert/admin.diveintodream.cn.key; 
           ssl_session_timeout 5m;
           ssl_ciphers ECDHE-RSA-AES128-GCM-SHA256:ECDHE:ECDH:AES:HIGH:!NULL:!aNULL:!MD5:!ADH:!RC4;
           ssl_protocols TLSv1 TLSv1.1 TLSv1.2;
           ssl_prefer_server_ciphers on;
